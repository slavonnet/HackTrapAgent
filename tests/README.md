...
```bash
./tests/run_service_tests.sh ssh telnetd ftp ntp nfs postgresql mysql redis elasticsearch clickhouse bgp l2tp ike2 openvpn radius imap pop3 smtp ad rabbitmq
```
