...
```bash
./tests/run_service_tests.sh asterisk ssh telnetd ftp ntp nfs postgresql mysql redis elasticsearch bgp l2tp ike2 openvpn radius imap pop3 smtp ad rabbitmq
```
