...
2. Run service tests:
   ...
   ```bash
   chmod +x tests/run_service_tests.sh tests/common/compose_test_lib.sh tests/ssh/test_fail2ban_scope.sh tests/ftp/test_fail2ban_scope.sh tests/l2tp/test_fail2ban_scope.sh tests/ike2/test_fail2ban_scope.sh tests/openvpn/test_fail2ban_scope.sh
